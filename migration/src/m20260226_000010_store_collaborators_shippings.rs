...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(StoreCollaborators::Id).integer().not_null().auto_increment().primary_key())
                    .col(ColumnDef::new(StoreCollaborators::Pid).uuid().not_null().unique_key())
                    .col(ColumnDef::new(StoreCollaborators::StoreId).integer().not_null())
                    .col(ColumnDef::new(StoreCollaborators::UserId).integer().not_null())
                    // Roles: 'owner' | 'admin' | 'shipping' | 'viewer'
                    .col(ColumnDef::new(StoreCollaborators::Role).string_len(20).not_null().default("shipping"))
                    .col(ColumnDef::new(StoreCollaborators::Active).boolean().not_null().default(true))
                    .col(ColumnDef::new(StoreCollaborators::CreatedAt).timestamp_with_time_zone().not_null().default(Expr::current_timestamp()))
                    .col(ColumnDef::new(StoreCollaborators::UpdatedAt).timestamp_with_time_zone().not_null().default(Expr::current_timestamp()))
                    .foreign_key(
                        ForeignKey::create()
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(OrderShippings::Id).integer().not_null().auto_increment().primary_key())
                    .col(ColumnDef::new(OrderShippings::Pid).uuid().not_null().unique_key())
                    ...
                    .col(ColumnDef::new(OrderShippings::Carrier).string_len(64).not_null().default("manual"))
                    ...
                    .col(ColumnDef::new(OrderShippings::Status).string_len(30).not_null().default("pending"))
                    .col(ColumnDef::new(OrderShippings::ShippedAt).timestamp_with_time_zone())
                    .col(ColumnDef::new(OrderShippings::EstimatedDeliveryAt).timestamp_with_time_zone())
                    ...
                    .col(ColumnDef::new(OrderShippings::ProviderData).json_binary().not_null().default("{}"))
                    .col(ColumnDef::new(OrderShippings::Notes).text())
                    .col(ColumnDef::new(OrderShippings::CreatedAt).timestamp_with_time_zone().not_null().default(Expr::current_timestamp()))
                    .col(ColumnDef::new(OrderShippings::UpdatedAt).timestamp_with_time_zone().not_null().default(Expr::current_timestamp()))
                    .foreign_key(
                        ForeignKey::create()
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.drop_table(Table::drop().table(OrderShippings::Table).to_owned()).await?;
        manager.drop_table(Table::drop().table(StoreCollaborators::Table).to_owned()).await?;
        Ok(())
    }
}
