        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Products::Description).text().not_null().default(""))
                    .col(ColumnDef::new(Products::Handle).string_len(256).not_null())
                    .col(ColumnDef::new(Products::Status).string_len(20).not_null().default("draft"))
                    .col(ColumnDef::new(Products::ProductType).string_len(20).not_null().default("physical"))
                    .col(ColumnDef::new(Products::CategoryId).integer())
                    .col(ColumnDef::new(Products::Tags).json_binary().not_null().default("[]"))
                    .col(ColumnDef::new(Products::Metadata).json_binary().not_null().default("{}"))
                    ...
                    .col(ColumnDef::new(Products::Featured).boolean().not_null().default(false))
